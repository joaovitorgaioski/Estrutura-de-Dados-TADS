...
public class Array<T> implements IArray<T> {
    ...
    public void sort(Comparator<T> comparator) {
        this.sort(SortAlgorithm.BUBBLESORT, Order.ASC, comparator);
    }

    @Override
    public void sort(SortAlgorithm algorithm, Order order, Comparator<T> comparator) {
        this.sort(algorithm, order, comparator, this.size());
    }
    ...
    public void sort(SortAlgorithm algorithm, Order order, Comparator<T> comparator, int amount) {
        switch (algorithm) {
            ...
            case SELECTIONSORT -> selectionSort(comparator, order, amount);
    ...
    private void selectionSort(Comparator<T> comparator, Order order, int amount) {
        for (int i = 0; i < this.size() - 1 && i < amount; i++) {
